...
public class PlayerController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Input.GetKeyDown(KeyCode.Mouse0) && !gumExtended)
        {
            ...
            // If extending towards the latched surface, then jump
            ...
            {
                gumExtended = true;
                GameObject hookInstance = Instantiate(gumPrefab, transform);
                hookInstance.GetComponent<HookMovement>().Initialize(this, direction);
            }
        }
    }
